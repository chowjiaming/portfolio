...
export const content: Project[] = [
  {
    ...
    screenshot: '/img/screenshots/tip-calculator-screenshot.png',
  ...
  },
  {
    ...
    screenshot: '/img/screenshots/countries-screenshot.png',
  ...
  {
    name: 'Languages Flashcard App',
    screenshot: '/img/screenshots/1000words-screenshot.png',
